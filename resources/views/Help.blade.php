...
<section align="center" id="helpcenterindesktopmode">
    ...
    <h1 align="center" class="black-text col-md-12" style="font-weight:bold;">Pusat Bantuan</h1>
    ...
    <div class="card-body">
    <h4 align="center" class="card-title font-weight-bold">Pengiriman & Pengembalian</h4>

    <a href="Shipping-and-Returns" align="center" type="button" class="btaobtn btaobtn-outline-primary  btn-md  animated pulse infinite slow">Baca selengkapnya</a>
    </div>
    </div>
    ...
    <div class="card-body">
    <h4 align="center" class="card-title font-weight-bold">Kontak Kami</h4>

    <a href="Contact" align="center" type="button" class="btaobtn btaobtn-outline-primary  btn-md  animated pulse infinite slow">Baca selengkapnya</a>
    </div>
    </div>
