...
@section('content')
<section>
<h1 align="center" class="black-text col-md-12" style="font-weight:bold;">Pertanyaan yang Sering Ditanyakan</h1>
  <p align="center"></p>
  <div align="center">
    <!--Grid column-->
        ...
        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
          ...
          <div class="card p-3">
            ...
            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
              ...
              <div class="card-body">
              Untuk melakukan pemesanan anda harus melakukan login terlebih dahulu. Bila anda belum mempunyai akun,
                  maka anda akan kami arahkan untuk melakukan register atau pendaftaran akun terlebih dahulu.
              </div>
            </div>
