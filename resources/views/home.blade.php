...
<!-- About Starts Here -->
 ...
 <div id="About" class="container-fluid" style="background:white;">
    <br><br>
      <div class="row">
        <div class="col-md-4">
        <img src=" {{asset('public/Img/nasi.jpg')}}" alt="" class="img-fluid" >
        </div>
        <div  align="center" class="col-md-8">
            <h1 class="black-text" style="font-weight:bold;">Menu Katering</h1>
            ...
            <div class="row my-5" style="font-size:30px;">
              <div class="col-md-6" >
                    ...
                    <li><i class="fab fa-pagelines"></i> Paket daging</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i> Paket ikan</li>
                    <li><i class="fab fa-pagelines"></i> Paket Prasmanan</li>
                  </ul>
              </div>
            </div>
