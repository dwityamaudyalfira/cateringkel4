                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                 <tr>
                                    ...
                                    <td>
                                    @endif
                                     <form action="pemilik-Update-Shipping-Status" method="POST">
                                                 @csrf
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    @endif
                                     <form action="pemilik-Update-Delivery-Status" method="POST">
                                                 @csrf
                                                 <input type="hidden" value="{{session('Order_id')}}" name="Order_id">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                              ...
                                              <form action="pemilik-Update-Payment-Status" method="POST">
                                                 @csrf
                                                 <input type="hidden" value="{{session('Order_id')}}" name="Order_id">
                ...
                <!--Grid row-->
                    ...
                    <ul align="left" style="color:red">
                          @if(session('Order_Cancel_Status')==1 )
                            ...
                            <li>Click <a href="{{url('pemilik-Order-Re-Cancel/'.session('Order_id').'')}}" >Here</a> to Re Cancel the this Order</li>
                         @else
                                 <li>
