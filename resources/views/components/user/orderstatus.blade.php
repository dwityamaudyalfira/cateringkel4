                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                        ...
                                        @if(session('p_status')=='pending')
                                         {{session('p_status')}}
{{--                                                <a href="/proceed_to_Payment/{{session('Order_id')}}" class="btaobtn btaobtn-success">Pay Now</a>--}}
                                         @else
                                             {{session('p_status')}}
                                         @endif
            ...
            @else
                ...
                <h3>Pesanan Ini Dibatalkan Oleh Anda Pada {{session('Order_Cancelled_On')}}</h3>
            @endif
        </div>
