                            ...
                            @endif
                              ...
                              <p>{{$Product->description}}</p>
                                ...
                                <input type="hidden"   name="product_id"   min=0 value="{{$Product->id}}" required class="form-control product_id">
                                   <p> Harga : <strong style="font-size:20px;font-family: 'Balsamiq Sans', cursive;">Rp {{$Product->price}}</strong></p>
                                      <?php echo $Product->additional_info;?>
                                <div class="col-md-6" style="margin-left:-20px;">
                                  <input type="number" class="form-control quantity" name="quantity" placeholder="Jumlah">
                                </div>
                              <div class="col-md-12 my-3"  id="changethebuttons">


                                      <button class="btaobtn btaobtn-primary px-2 py-2 book-now-btn" >Pesan Sekarang</button>
                                      <button   class="btaobtn btaobtn-light px-2 py-2 add-to-cart-btn">Tambahkan ke Keranjang</button>
