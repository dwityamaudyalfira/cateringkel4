...
{
    Route::get('/pemilik-dash', 'Pemilik\LinksController@index');
    Route::get('pemilik-Orders','Pemilik\LinksController@showorders');
    Route::get('pemilik-Transactions','Pemilik\LinksController@showTransactions');
    Route::get('/pemilik-products', 'pemilik\LinksController@products');
});
